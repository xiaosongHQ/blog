                                       ...
                                       @foreach($links as $v)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href='/link/{{$v['id']}}/edit'><button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</button></a>
                                                      <form style="float:right;" action="/link/{{$v['id']}}" method='post'>
